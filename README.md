...
Children can draw shapes on the screen, and the app uses machine learning to recognize each drawing and respond with friendly feedback.

⸻

🚀 Features • 🎨 Interactive drawing canvas • 🧠 Shape recognition using TensorFlow Lite • ✅ Supports Circle ⭕️, Square 🔲, Triangle 🔺 • 🔊 Voice and visual feedback • 👶 Child-friendly colorful interface
...
👥 Team & Collaboration
This project was built as a team effort. Each member contributed to different parts of the application including UI design, drawing logic, machine learning integration, and project structure.
...
Kamara Alleyne 📧 kamara.alleyne@gmail.com GitHub: https://github.com/KodyKam
